  ...
  useEffect(() => {
    ...
    map.current.on("click", (e) => {
      ...
      new mapboxgl.Popup({
        ...
        .setHTML(
          `<div className="popup-content__item">Country:<span>${
            weather.location?.country
          }</span></div><div className="popup-content__item">City:<span>${
            weather.location?.name
          }</span></div><div className="popup-content__item">Temperature:<span>${Math.floor(
            weather.current?.temp_c
          )}&degC</span></div><div className="popup-content__item">Precipitation:<span>${
